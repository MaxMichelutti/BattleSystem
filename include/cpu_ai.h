...
class CPUAI{
    private:
    unsigned int skill;
    int computeAttackUtility(unsigned int attack_id, Battler* cpu_active,MonsterTeam * cpu_team,Battler* enemy_active, Field*field)const;
    ...
    Choice* getBestAttackChoice(Battler*,MonsterTeam*,Battler*,Field*)const;
